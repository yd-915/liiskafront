          ...
          <div className="flex flex-col items-center justify-center mx-auto">
            <Card>
              ...
              <Card.Footer>
                {data ? (
                  <Button
                    className="text-white bg-yellow-600 hover:bg-orange-500"
                  ...
                  <Link
                    href="/auth/login"
                    className="flex items-center justify-center px-5 py-2 space-x-3 text-white bg-yellow-600 rounded hover:bg-orange-500"
                  >
                    Create an account
                  </Link>
                )}
